  ...
  const pricing = {
    interior: [
      ...
      },
      {
        ...
        features: [
          ...
          "Detailed cleaning of dashboard, console, doors",
        ],
        prices: {
          sedan: 159,
          suv: 189,
    ...
    combo: [
      ...
      },
      {
        ...
        features: [
          "Include all services from Supreme Interior Package",
          "Include all services from Clay & Seal Package",
        ],
        prices: {
          sedan: 289,
          suv: 309,
